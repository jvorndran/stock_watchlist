...
const StockSubHeader = ({ stockData }) => {
    ...
    return (
        ...
        <div className="grid grid-cols-3 gap-4 rounded-3xl mx-10 my-4 p-2 text-white bg-black-steel ">

            <div className="col-span-1 flex justify-start items-center p-3">
            ...
            <div className="col-span-1">
                ...
                <h4 className="flex">Industry: <span className="ml-auto">{data.Industry.charAt(0).toUpperCase() + data.Industry.slice(1).toLowerCase()}</span></h4>
